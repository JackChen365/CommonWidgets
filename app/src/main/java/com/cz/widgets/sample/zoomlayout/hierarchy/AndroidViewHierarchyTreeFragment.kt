...
import kotlinx.android.synthetic.main.fragment_zoom_hierarchy_sample.*
...
class AndroidViewHierarchyTreeFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_zoom_hierarchy_sample,container,false)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        val context=context?:return
        hierarchyView.addItemDecoration(HierarchyItemDecoration(context))
