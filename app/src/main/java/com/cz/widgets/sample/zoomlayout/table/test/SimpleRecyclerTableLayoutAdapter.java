...
public class SimpleRecyclerTableLayoutAdapter extends TableZoomTestLayout.Adapter<String> {
    ...
    public SimpleRecyclerTableLayoutAdapter(Context context, List<List<String>> items) {
