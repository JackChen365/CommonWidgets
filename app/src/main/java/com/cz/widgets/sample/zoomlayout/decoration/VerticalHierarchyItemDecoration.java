 ...
 */
public class VerticalHierarchyItemDecoration extends ItemDecoration {
    private final RectF tempRect=new RectF();
    private final Paint paint=new Paint(Paint.ANTI_ALIAS_FLAG);
    private int horizontalSpacing;
    private int verticalSpacing;
    private float strokeWidth;
    public VerticalHierarchyItemDecoration(Context context) {
    ...
    public void onDrawOver(@NonNull Canvas canvas, float scaleX, float scaleY) {
        ...
        for(int i=0;i<childCount;i++){
            ...
            VerticalHierarchyLayout.LayoutParams layoutParams = (VerticalHierarchyLayout.LayoutParams) childView.getLayoutParams();
    ...
    private<E> RectF getLayoutRect(View childView,TreeNode<E> treeNode,float scaleX,float scaleY){
        ...
        int left=paddingLeft+treeNode.centerBreadth*decoratedMeasuredWidth+decoratedRect.left;
        int top=paddingTop+treeNode.depth * decoratedMeasuredHeight+decoratedRect.top;
