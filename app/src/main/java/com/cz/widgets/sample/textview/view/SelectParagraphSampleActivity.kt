...
import kotlinx.android.synthetic.main.activity_text_select_paragraph_sample.*

@SampleSourceCode(".*SelectParagraphSampleActivity.kt")
@RefRegister(title= R.string.text_select_title,desc= R.string.text_select_desc,category = R.string.text_widget)
class SelectParagraphSampleActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_text_select_paragraph_sample)
        ...
        textView.post { textView.setSelectText(0,20) }
    }
}
